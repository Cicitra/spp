            ...
            <tr>
                ...
                <td>
                    ...
                    if($kekurangan == 0) {
                        ...
                        <a href="?url=tambah-pembayaran&nisn=<?= $data['nisn']?>&kekurangan=<?= $kekurangan?>" class="btn btn-info">Pilih & bayar</a>
                    <?php }?>
                </td>
                <td>
                    <a 
                        href="?url=history-pembayaran&nisn=<?= $data['nisn']?>" 
                        class="btn btn-secondary" >Lihat History
                    </a>
                </td>
            </tr>
